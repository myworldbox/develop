...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1605: x0 => ({facingMode: x0}),
      _1606: x0 => ({video: x0}),
      _1607: () => globalThis.navigator.mediaDevices.enumerateDevices(),
      _1608: x0 => ({exact: x0}),
      _1609: x0 => ({deviceId: x0}),
      _1610: x0 => globalThis.navigator.mediaDevices.getUserMedia(x0),
      _1611: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1612: x0 => x0.play(),
      _1613: x0 => x0.getTracks(),
      _1614: x0 => x0.stop(),
      _1615: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      _1616: (x0,x1,x2,x3,x4) => x0.getImageData(x1,x2,x3,x4),
      _1617: (x0,x1,x2) => globalThis.jsQR(x0,x1,x2),
      _1618: x0 => x0.decode(),
      ...
      _1703: (x0,x1) => x0.querySelector(x1),
      _1704: (x0,x1) => x0.createElement(x1),
      _1705: (x0,x1) => x0.append(x1),
      _1734: (x0,x1) => x0.querySelector(x1),
      _1735: (x0,x1) => x0.querySelector(x1),
      _1756: () => new SpeechSynthesisUtterance(),
      _1757: x0 => x0.pause(),
      _1758: x0 => x0.resume(),
      ...
      _1765: x0 => x0.resume(),
      _1766: (x0,x1) => x0.speak(x1),
      _1767: x0 => x0.cancel(),
      _1768: x0 => x0.pause(),
      _1769: x0 => x0.getVoices(),
      _1770: x0 => x0.getVoices(),
      _1771: x0 => x0.getVoices(),
      _1772: x0 => x0.getVoices(),
      _1784: x0 => new Array(x0),
      _1786: x0 => x0.length,
      _1788: (x0,x1) => x0[x1],
      _1789: (x0,x1,x2) => x0[x1] = x2,
      _1792: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1794: x0 => new Int8Array(x0),
      _1795: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1796: x0 => new Uint8Array(x0),
      _1804: x0 => new Int32Array(x0),
      _1806: x0 => new Uint32Array(x0),
      _1808: x0 => new Float32Array(x0),
      _1810: x0 => new Float64Array(x0),
      ...
      _1821: (o, a) => o + a,
      _1842: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1843: () => new TextDecoder("utf-8", {fatal: true}),
      _1844: () => new TextDecoder("utf-8", {fatal: false}),
      _1845: x0 => new WeakRef(x0),
      _1846: x0 => x0.deref(),
      _1852: Date.now,
      _1854: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1855: s => {
      ...
      _1865: () => globalThis.WeakRef,
      _1876: s => JSON.stringify(s),
      _1877: s => printToConsole(s),
      _1878: a => a.join(''),
      _1879: (o, a, b) => o.replace(a, b),
      _1881: (s, t) => s.split(t),
      _1882: s => s.toLowerCase(),
      _1883: s => s.toUpperCase(),
      _1884: s => s.trim(),
      _1885: s => s.trimLeft(),
      _1886: s => s.trimRight(),
      _1887: (s, n) => s.repeat(n),
      _1888: (s, p, i) => s.indexOf(p, i),
      _1889: (s, p, i) => s.lastIndexOf(p, i),
      _1890: (s) => s.replace(/\$/g, "$$$$"),
      _1891: Object.is,
      _1892: s => s.toUpperCase(),
      _1893: s => s.toLowerCase(),
      _1894: (a, i) => a.push(i),
      _1895: (a, i) => a.splice(i, 1)[0],
      _1897: (a, l) => a.length = l,
      _1898: a => a.pop(),
      _1899: (a, i) => a.splice(i, 1),
      _1901: (a, s) => a.join(s),
      _1902: (a, s, e) => a.slice(s, e),
      _1903: (a, s, e) => a.splice(s, e),
      _1904: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1905: a => a.length,
      _1907: (a, i) => a[i],
      _1908: (a, i, v) => a[i] = v,
      _1910: (o, offsetInBytes, lengthInBytes) => {
      ...
      _1913: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1914: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      ...
      _1920: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1921: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1922: (t, s) => t.set(s),
      _1924: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1926: o => o.buffer,
      _1927: o => o.byteOffset,
      _1928: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1929: (b, o) => new DataView(b, o),
      _1930: (b, o, l) => new DataView(b, o, l),
      _1931: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1932: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1933: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1934: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1935: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1936: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1937: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1938: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1939: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1940: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1941: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1942: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1945: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1946: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1947: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1948: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1949: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1950: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1963: (o, t) => o instanceof t,
      ...
      _1967: o => Object.keys(o),
      _1968: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1969: (handle) => clearTimeout(handle),
      _1970: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1971: (handle) => clearInterval(handle),
      _1972: (c) =>
      ...
      _2155: x0 => x0.data,
      _2156: () => globalThis.document,
      _2180: x0 => x0.src,
      _2181: (x0,x1) => x0.src = x1,
      _2182: x0 => x0.naturalWidth,
      _2183: x0 => x0.naturalHeight,
      _2208: x0 => x0.status,
      _2209: (x0,x1) => x0.responseType = x1,
      _2211: x0 => x0.response,
      _2923: x0 => x0.videoWidth,
      _2924: x0 => x0.videoHeight,
      _2961: (x0,x1) => x0.srcObject = x1,
      _3640: x0 => x0.width,
      _3641: (x0,x1) => x0.width = x1,
      _3642: x0 => x0.height,
      _3643: (x0,x1) => x0.height = x1,
      _3775: x0 => x0.data,
      _4081: () => globalThis.window,
      _4145: x0 => x0.navigator,
      _4536: x0 => x0.userAgent,
      _6862: () => globalThis.document,
      _6955: x0 => x0.body,
      _7306: (x0,x1) => x0.id = x1,
      _7333: x0 => x0.children,
      _10241: x0 => x0.readyState,
      _10556: x0 => x0.deviceId,
      _10557: x0 => x0.kind,
      _10558: x0 => x0.label,
      _13837: () => globalThis.window.flutterCanvasKit,
      _13838: () => globalThis.window._flutter_skwasmInstance,
      _13839: () => globalThis.speechSynthesis,
      _13847: (x0,x1) => x0.lang = x1,
      _13849: (x0,x1) => x0.pitch = x1,
      _13852: (x0,x1) => x0.rate = x1,
      _13854: (x0,x1) => x0.text = x1,
      _13855: (x0,x1) => x0.voice = x1,
      _13856: x0 => x0.voice,
      _13858: (x0,x1) => x0.volume = x1,
      _13859: (x0,x1) => x0.onstart = x1,
      _13860: (x0,x1) => x0.onend = x1,
      _13861: (x0,x1) => x0.onpause = x1,
      _13862: (x0,x1) => x0.onresume = x1,
      _13863: (x0,x1) => x0.onerror = x1,
      _13864: (x0,x1) => x0.onboundary = x1,
      _13866: x0 => x0.lang,
      _13867: x0 => x0.localService,
      _13868: x0 => x0.name,
